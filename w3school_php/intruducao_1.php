...
<head>
    ...
    <title>Introdução a Linguagem PHP</title>
    <style>
        body {
...
<body>
    ...
    <h1 align= 'center'>Introdução a Linguagem PHP</h1>
    <hr>

    <p>PHP é uma linguagem de script de servidor e uma ferramenta poderosa <br> para criar páginas da Web dinâmicas e interativas.</p>

    <div>
        <h2>O que é PHP?</h2>
        
        <p>
            É um acrônimo para "PHP: Hypertext Preprocessor" <br>
    ...
    <div>
        ...
        <p>
            ...
            Arquivos PHP têm extensão "<mark>.php</mark>" <br>
        </p>
